...
Chamo-me **Ricardo Simba**, sou Engenheiro de Redes IP e actualmente a trabalhar para a **Cisco** como **Systems Engineer**. Oficialmente comecei a minha carreira profissional em 2007, tendo ate aqui acumulado experiencia em redes IP de operadoras de Internet (**ISP**) e empresariais, assim como em sistemas **Unix** / Linux, programacao em **C/Python**, e scripting em **Bash**. 
